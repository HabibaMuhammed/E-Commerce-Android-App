...
public class SettinsActivity extends AppCompatActivity {
    ...
    private EditText fullNameEditText, userPhoneEditText, addressEditText, insertuserdate;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        insertuserdate = (EditText) findViewById(R.id.settings_Birthdate);
        ...
        insertuserdate.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                DatePickerDialog datePickerDialog = new DatePickerDialog(
                        SettinsActivity.this, new DatePickerDialog.OnDateSetListener() {
                    @Override
                    public void onDateSet(DatePicker view, int year, int month, int day) {
                        month = month+1;
                        String date = day+"/"+month+"/"+year;
                        insertuserdate.setText(date);
                    }
                },year,month,day);
    ...
    private void updateOnlyUserInfo() {
        ...
        userMap.put("Date of Birth",insertuserdate.getText().toString());
    ...
    private void userInfoSaved()
    {
        ...
        else if (TextUtils.isEmpty(insertuserdate.getText().toString()))
        {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                if (dataSnapshot.exists())
                {
                    if (dataSnapshot.child("image").exists())
                    {
                        ...
                        insertuserdate.setText(birthdate);
                    }
                }
