...
public class ProductDetailsActivity extends AppCompatActivity {
    ...
    private void addingToCartList() {
        ...
        cartListRef.child("User view").child(user.getUid()).child("Products").child(productID).updateChildren(cartMap).addOnCompleteListener(new OnCompleteListener<Void>() {
            @Override
            public void onComplete(@NonNull Task<Void> task) {
                if (task.isSuccessful()){
                    cartListRef.child("Admin view").child(user.getUid())
